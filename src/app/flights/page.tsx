...
import { useStoreData, INITIAL_FLIGHTS, FlightFare, INITIAL_ENQUIRIES, EnquiryItem } from "@/lib/storage";
            ...
            >
              ...
              <div className="flex items-center justify-between pt-2">
                <div>
                  ...
                  <span className="text-3xl font-bold text-amber-400">{flt.currency}{flt.farePrice.toLocaleString()}</span>
                </div>
              ...
              <form className="space-y-4 text-xs" onSubmit={handleFlightSubmit}>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-white/10">
                  <div>
                    ...
                    <span className="text-2xl font-bold text-amber-400">{activeFlightModal.currency}{(activeFlightModal.farePrice * seatsRequested).toLocaleString()}</span>
                  </div>
